...
TEST(FlexCard, ConstructorSeedsStyleDefaults) {
  ...
  EXPECT_EQ(::roo_windows::material3::ColorToken::kSurfaceContainerLow,
            elevated.containerRole());
...
TEST(FlexCard, OverridesPersistAcrossStyleChanges) {
  ...
  EXPECT_EQ(::roo_windows::material3::ColorToken::kPrimaryContainer,
            card.containerRole());
  EXPECT_EQ(::roo_windows::material3::ColorToken::kOutline,
            card.outlineRoleOverride());
...
TEST(FlexCard, ClearOverrideRecomputesFromCurrentStyle) {
  ...
  EXPECT_EQ(::roo_windows::material3::ColorToken::kSurface,
            card.containerRole());
  EXPECT_EQ(::roo_windows::material3::ColorToken::kOutlineVariant,
            card.outlineRoleOverride());
  EXPECT_EQ(0, card.getElevation());
  EXPECT_EQ(SmallNumber::Of16ths(Scaled(16)),
            card.getBorderStyle().outline_width());
