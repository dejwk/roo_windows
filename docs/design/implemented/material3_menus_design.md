...
1. The menu-hosting phases of
   [Transient surface hosting](../implemented/transient_surface_hosting_design.md) are implemented
...
[Transient surface hosting](../implemented/transient_surface_hosting_design.md). The menu requests
...
[Transient surface hosting design](../implemented/transient_surface_hosting_design.md#rejected-alternatives).
