...
| Layout scaffold | Shared adaptive primitives, the fixed-slot `LayoutScaffold` shell, and fixed-slot `PaneLayout` are implemented. `GridLayout`, navigation rail, and drawer remain outstanding. |
