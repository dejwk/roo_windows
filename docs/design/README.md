...
| Layout scaffold | Shared adaptive primitives and the fixed-slot `LayoutScaffold` shell are implemented. `PaneLayout`, `GridLayout`, navigation rail, and drawer remain outstanding. |
