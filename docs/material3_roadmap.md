...
| <a id="p1-7"></a>[P1.7](#p1-7) | Implement Material 3 menus | <img src="material3_roadmap_status_in_progress.svg" width="20" height="20" alt="In progress" title="In progress"> | [Menus](design/in_progress/material3_menus_design.md), reconciled by P1.6 | P1.6b | Phases 1–3 implement rows, grouped/scrolled panels, RTL-aware placement, shared-host presentation, synchronous source capture, focus, optional trigger paint, teardown, and two anchored examples. Complete selection, submenus/keyboard, and the final migration/memory audit. |
