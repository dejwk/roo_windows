...
Implementation is scheduled immediately before menus as P1.6b.
...
| <a id="p1-6b"></a>[P1.6b](#p1-6b) | Implement menu hosting prerequisites | <img src="material3_roadmap_status_pending.svg" width="20" height="20" alt="Pending" title="Pending"> | The implementation plan in [Transient surface hosting](design/proposed/transient_surface_hosting_design.md), consuming the existing [Non-touch input](design/implemented/non_touch_input_design.md) focus contract and [presentation-pin](design/in_progress/transient_presentation_pins_design.md) host | P1.6a | Active owner-scoped focus tests pass; the combined host layer enforces owner/non-owner physical-key and semantic-editor barriers, hosted root-first Back/Escape, and owner teardown; detached and foreign required placement sources fail before admission, invalid optional trigger sources omit only retained paint, rect pins preserve widget-pin behavior, and host/layer size ceilings hold. This phase does not structurally migrate legacy `Dialog`. |
...
| <a id="p1-8"></a>[P1.8](#p1-8) | Implement basic Material 3 dialogs | <img src="material3_roadmap_status_pending.svg" width="20" height="20" alt="Pending" title="Pending"> | Phases 1–2 of [Dialogs](design/proposed/material3_dialogs_design.md) | P0.4, P0.5, P1.6b | Basic/alert dialogs use the shared display-covered host with an explicit interaction owner, detach the complete hosted root before completion, retain configured body state for reopen, restore focus, handle Back/Escape, and pass unit and golden tests. Full-screen dialogs are deferred. |
