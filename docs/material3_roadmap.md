...
| <a id="p1-8"></a>[P1.8](#p1-8) | Implement basic Material 3 dialogs | <img src="material3_roadmap_status_pending.svg" width="20" height="20" alt="Pending" title="Pending"> | Phases 1–2 of [Dialogs](design/in_progress/material3_dialogs_design.md) | P0.4, P0.5, P1.6b | Phase 1 shared scaffold, ownership, focus, and host integration is complete. Basic/alert dialogs must use that shared display-covered host with an explicit interaction owner, retain configured body state for reopen, restore focus, handle Back/Escape, and pass unit and golden tests. Suitable in-repository legacy alert and radio-list call sites migrate to the Material 3 family; external compatibility types may remain. Full-screen dialogs are deferred. |
