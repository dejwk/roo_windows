...
| ID | Deliverable | State | Design | Depends on | Completion check |
| --- | --- | --- | --- | --- | --- |
| <a id="p2-1"></a>[P2.1](#p2-1) | Implement single-line Material 3 text fields | <img src="material3_roadmap_status_open.svg" width="20" height="20" alt="Open" title="Open"> | [Text fields](design/proposed/material3_text_fields_design.md) | P0.3 | Complete reviewed design Phases 1–5: generalize the task-owned editor target, use Material 3 typography, implement filled/outlined fields, explicit edit activation, cursor/selection/horizontal scrolling, error/supporting text, secure entry, lifetime/resource tests, goldens, and example. Multiline and IME composition are not in this design. |
