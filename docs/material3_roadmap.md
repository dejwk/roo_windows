...
| <a id="p1-4"></a>[P1.4](#p1-4) | Implement the compact `LayoutScaffold` slice | <img src="material3_roadmap_status_open.svg" width="20" height="20" alt="Open" title="Open"> | [Layout scaffold](design/proposed/material3_layout_scaffold_design.md) | P1.1, P1.3 | Implement design Phases 1–2 and the compact consumer from Phase 5: top app bar, body, bottom navigation, FAB/snackbar insets, RTL, tests, and one example. `PaneLayout` and `GridLayout` remain deferred design phases and do not block this row. |
