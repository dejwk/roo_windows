...
| [Tabs and ScrollableTabs](../src/roo_windows/material3/tabs/tabs.cpp) | Shared 200 ms quadratic ease-out indicator channel; scrollable tabs temporarily retain a separate scroll execution ID and motion state | Base tag 0 is reserved for the indicator and derived tags begin at 1, allowing independent channels on one widget |
