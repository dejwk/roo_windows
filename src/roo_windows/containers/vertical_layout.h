...
class VerticalLayout : public Panel {
 public:
  ...
  /// Sets the gravity used for: (a) aligning the column when there is extra
  /// vertical space, and (b) as default horizontal gravity for children that
  ...
  /// (useful for equal-height columns).
 ...
 protected:
  /// Measures each child against the available height, applying weights to
  /// the leftover vertical space; reports the column's measured size.
  Dimensions onMeasure(WidthSpec width, HeightSpec height) override;

  /// Places children top-to-bottom at their measured heights, applying each
  /// child's horizontal gravity within `rect`.
